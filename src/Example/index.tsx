    ...
    return (
        <div className="test">
            ...
            <div className="test__row">
                <Select onChange={onSelectChange} label="Домен" id="test-domen" options={mockListOfDomains} invalid={false} />
                <Input
                    label="Логин"
                    id="firstInput"
                    value={firstInput}
                ...
                />
                <Input label="Логин" id="secondInput" value={secondInput} onChange={onChange} invalid={true} name="secondInput" />
