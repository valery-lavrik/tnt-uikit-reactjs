...
export default function Icon({
    ...
    return (
        ...
        >
            ...
            />
            <path
                d="M14.4309 11.9969C14.4309 13.3254 13.3382 14.4115 12.0016 14.4115C10.6553 14.4115 9.56262 13.3254 9.56262 11.9969C9.56262 11.8321 9.58213 11.6779 9.6114 11.5227H9.66018C10.7431 11.5227 11.6212 10.6694 11.6602 9.60175C11.7675 9.58333 11.8846 9.57266 12.0016 9.57266C13.3382 9.57266 14.4309 10.6587 14.4309 11.9969Z"
                fill="#37383C"
            />
        </svg>
    );
