...
export default function Icon({ className = '', style = {}, onClick }: SvgPropsType) {
    return (
        ...
        >
            <path
                opacity="0.4"
                d="M21.9999 15.9402C21.9999 18.7302 19.7599 20.9902 16.9699 21.0002H16.9599H7.04988C4.26988 21.0002 1.99988 18.7502 1.99988 15.9602V15.9502C1.99988 15.9502 2.00588 11.5242 2.01388 9.29821C2.01488 8.88021 2.49488 8.64621 2.82188 8.90621C5.19788 10.7912 9.44688 14.2282 9.49988 14.2732C10.2099 14.8422 11.1099 15.1632 12.0299 15.1632C12.9499 15.1632 13.8499 14.8422 14.5599 14.2622C14.6129 14.2272 18.7669 10.8932 21.1789 8.97721C21.5069 8.71621 21.9889 8.95021 21.9899 9.36721C21.9999 11.5762 21.9999 15.9402 21.9999 15.9402Z"
                fill="#37383C"
            />
            <path
