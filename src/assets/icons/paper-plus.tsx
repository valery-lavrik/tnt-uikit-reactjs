...
export default function Icon({
    ...
    return (
        ...
        >
            ...
            <path
                opacity="0.4"
                d="M16.0841 2.56729C15.7851 2.25629 15.2631 2.47029 15.2631 2.90129V5.53829C15.2631 6.64429 16.1741 7.55429 17.2791 7.55429C17.9771 7.56229 18.9451 7.56429 19.7671 7.56229C20.1881 7.56129 20.4021 7.05829 20.1101 6.75429C19.0551 5.65729 17.1661 3.69129 16.0841 2.56729Z"
                fill="#37383C"
            />
            <path
